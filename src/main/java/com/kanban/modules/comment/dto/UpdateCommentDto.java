...
public class UpdateCommentDto extends ValidatedDto {
  @Schema(example = "<p>Updated comment content</p>", description = "HTML content of the comment (will be sanitized)")
  @IsString
  @IsNotEmpty
