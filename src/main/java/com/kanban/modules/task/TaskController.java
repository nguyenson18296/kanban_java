...
public class TaskController {
  ...
  @ApiResponse(responseCode = "403", description = "Requires member role")
  ...
  public List<Map<String, Object>> findAll(@CurrentUser("id") String userId) {
    return taskService.findAllForUser(userId).stream().map(t -> t.toJson(TaskService.FIND_ALL_RELATIONS)).toList();
  }
  ...
  public Map<String, Object> findByTicketId(@Param("ticketId") String ticketId,
    ...
    return full(taskService.findByTicketIdForUser(ticketId, userId));
  }
  ...
  public Map<String, Object> findOne(@Param(value = "id", pipe = Param.Pipe.UUID) String id,
      @CurrentUser("id") String userId) {
    return full(taskService.findOneForUser(id, userId));
  }
  ...
  public ApiListResponse<Map<String, Object>> findSubtasks(@Param(value = "id", pipe = Param.Pipe.UUID) String id,
      @CurrentUser("id") String userId) {
    return taskService.findSubtasksForUser(id, userId);
  }
  ...
  public Map<String, Object> reorderSubtask(@Param(value = "id", pipe = Param.Pipe.UUID) String id,
      ...
      @CurrentUser("id") String userId) {
    return full(taskService.reorderSubtask(id, subtaskId, dto.position, userId));
  }
